...
export AssignmentPlanner, GreedyPlanner, FormationPlanner

struct GreedyPlanner end
struct FormationPlanner end
struct AssignmentPlanner end

function run_mdma_experiment(experiment_name::String, path_to_experiments::String, planner::GreedyPlanner)
...
function run_mdma_experiment(experiment_name::String, path_to_experiments::String, planner::AssignmentPlanner)
    # TODO Save solution
end

function run_mdma_experiment(experiment_name::String, path_to_experiments::String, planner::FormationPlanner)
    # TODO Save solution
end

function run_mdma_experiments(experiment_names::Vector{String}, path_to_experiments::String)
